// $ANTLR 2.7.4: "language.g" -> "ProgramLexer.java"$
...
public class ProgramLexer extends antlr.CharScanner implements ProgramParserTokenTypes, TokenStream
 {
public ProgramLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public ProgramLexer(Reader in) {
	this(new CharBuffer(in));
}
public ProgramLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public ProgramLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("repeat", this), new Integer(12));
	...
	literals.put(new ANTLRHashString("become", this), new Integer(13));
	...
	literals.put(new ANTLRHashString("in", this), new Integer(14));
